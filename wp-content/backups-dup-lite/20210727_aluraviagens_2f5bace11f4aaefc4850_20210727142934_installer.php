...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210727_aluraviagens_2f5bace11f4aaefc4850_20210727142934_archive.zip';
	const ARCHIVE_SIZE		 = '80822882';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2f5bace-27142934';
    const SECONDARY_PACKAGE_HASH = 'a9ceaa4-27142934';
	const VERSION			 = '1.4.2';
